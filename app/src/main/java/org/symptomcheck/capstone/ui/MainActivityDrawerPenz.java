...
//TODO#BPR_6
public class MainActivityDrawerPenz extends ActionBarActivity implements ICardEventListener, FloatingActionsMenu.OnFloatingActionsMenuUpdateListener {

    private final String TAG = MainActivityDrawerPenz.this.getClass().getSimpleName();
...
/*                mDrawerItemTitles.add(
                ...
                //mDetailUser += "Born on " + DateTimeUtils.convertEpochToHumanTime(Patient.getByMedicalNumber(mUser.getUserIdentification()).getBirthDate(), "DD/MM/YYYY")
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (notifier != null) {
                    ...
                    App.hideSoftKeyboard(MainActivityDrawerPenz.this);
            ...
            new MaterialDialog.Builder(context)
                    ...
                    .callback(new MaterialDialog.ButtonCallback() {
                        ...
                        public void onPositive(MaterialDialog dialog) {
                            ((MainActivityDrawerPenz)context)
                                    .doLogout();
                        }
